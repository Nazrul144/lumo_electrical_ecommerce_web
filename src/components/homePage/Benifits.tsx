            ...
            <div className="bg-[#C6E8244D] mt-16 pb-16">
                ...
                <div className="flex flex-col lg:flex-row gap-y-10 justify-around items-center pt-16">
                    <div className="flex flex-col gap-5 items-center justify-center">
                        <Image src="/logo/icon/payment.png" alt="hand" width={80} height={80} />
                    ...
                    <div className="flex flex-col gap-5 items-center justify-center">
                        <Image src="/logo/icon/return.png" alt="hand" width={80} height={80} />
                    ...
                    <div className="flex flex-col gap-5 items-center justify-center">
                        <Image src="/logo/icon/customer.png" alt="hand" width={80} height={80} />
