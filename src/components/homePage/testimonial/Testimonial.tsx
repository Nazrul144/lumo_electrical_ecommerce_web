...
const reviews = [
    {
        id: 1, imageName: "men", name: "Leona Paul",
    ...
    {
        id: 2, imageName: "men", name: "Fahim",
        review: `My experience with Mark is a complete sucess, from customer service, wide range of products, clean store, purchasing 
        experience, the newsletter. Thank you.`
    },
    {
        id: 3, imageName: "men", name: "Faisal",
        review: `My experience with Mark is a complete sucess, from customer service, wide range of products, clean store, purchasing 
        experience, the newsletter. Thank you.`
    },
    {
        id: 4, imageName: "men", name: "Faria",
        review: `My experience with Mark is a complete sucess, from customer service, wide range of products, clean store, purchasing 
        experience, the newsletter. Thank you.`
    },
    {
        id: 5, imageName: "men", name: "Digonto",
        review: `My experience with Mark is a complete sucess, from customer service, wide range of products, clean store, purchasing 
        experience, the newsletter. Thank you.`
    },
];
