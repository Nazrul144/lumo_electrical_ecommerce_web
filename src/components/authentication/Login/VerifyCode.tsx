    ...
    <div>
      <div className="w-full h-screen bg-[#FFFFFF]">
        <div className="lg:flex justify-center items-center gap-10 mt-5">
          <div className=" lg:w-1/2 flex flex-col items-center justify-center mx-auto border-1 border-gray-100 rounded-lg shadow-lg w-full md:w-[686px] px-20 h-[850px]">
